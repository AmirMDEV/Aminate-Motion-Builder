...
RELEASE_VERSION_LABEL = "Version 0.1.1 BETA"
...
def build_student_package():
    ...
    readme_lines = [
        ...
        "- Prop Take Offset Manager previews and stores selected prop constraint offsets per take so prop setups can survive different prop starting positions.",
